...
export const LoginForm = (): JSX.Element => {
    ...
    return (
        <form
            className={clsx('border rounded-lg max-w-sm sm:max-w-lg w-full flex flex-col gap-4 bg-base-100 text-base-content mx-6 my-4 justify-center items-center p-4')}
