    ...
    return (
        <div className={clsx('grid grid-cols-2 gap-4 overflow-y-auto')}>
            <div>
                ...
                <div className={clsx('flex gap-2 h-52 text-neutral-content justify-center items-center')}>
                    <div>
                        <TextInput placeholder={'reunion, birthday'} errorMessage={''} topLeftLabel='Event name:' />
                        <LinkInput placeholder={'youtube/facebook/google'} topLeftLabel='Links:' />
                    </div>
                    <div>
            ...
            <button type="button" className={clsx('btn btn-ghost btn-accent w-full h-full')}>+ Add Event</button>
        </div>
    )
}
